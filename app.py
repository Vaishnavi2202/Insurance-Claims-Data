...
if 'Complaint filed against' in data.columns and 'Complaint filed by' in data.columns:
    ...
    ax.set_xlabel('Complaint Filed Against', fontsize=10)
...
if 'Complaint type' in data.columns:
    ...
    ax.set_xlabel('Complaint Type', fontsize=10)  # Increased font size
    ax.set_ylabel('Number of Complaints', fontsize=10)  # Increased font size
    ax.tick_params(axis='y', labelsize=8)
    ax.tick_params(axis='x', labelsize=8)
